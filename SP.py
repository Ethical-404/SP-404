...
def reg():
    ...
    print ''
    print ''
    print '\x1b[1;92m  [Connected With Arbab Servers]'
    print ''
...
def reg2():
    ...
    print ''
    print '\x1b[1;96m '
    print ' \xe2\x80\xa2 THIS TOOL IS COMPLETELY CODED BY ARBAB MEMON  \xe2\x80\xa2 '
    time.sleep(5)
    login()
